<template>
    <div class="mx-auto px-8 py-20 my-100 rounded-xl" style="max-width: 90%">
      ...
      <RouterLink :to="{ name: 'AddCategory'}" class="btn btn-error mb-10" v-if="authStore.currentUser && authStore.currentUser.role.name === 'owner'">Add Data</RouterLink>
        ...
        <div
          ...
          <div class="card-body">
            ...
            <div class="card-actions justify-end">
              ...
              <RouterLink :to="{ name: 'UpdateCategory', params: { id: category.id }}" class="btn btn-error text-white" v-if="authStore.currentUser && authStore.currentUser.role.name === 'owner'">
                Edit<span class="pi pi-pencil"></span>
              </RouterLink>
  
              <button class="btn btn-neutral" @click="deleteCategory(category.id)" v-if="authStore.currentUser && authStore.currentUser.role.name === 'owner'">
